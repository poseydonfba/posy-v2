namespace Posy.V2.Infra.Data.MySql.Migrations
{
    ...
    public partial class initial : DbMigration
    {
        public override void Up()
        {
            ...
            //            Dir = c.DateTime(nullable: false, precision: 0),
            //            Der = c.DateTime(precision: 0),
            //            Email = c.String(nullable: false, maxLength: 256, storeType: "nvarchar"),
            //            EmailConfirmed = c.Boolean(nullable: false),
            //            PasswordHash = c.String(maxLength: 100, storeType: "nvarchar"),
            //            SecurityStamp = c.String(maxLength: 100, storeType: "nvarchar"),
            ...
            //            CurrencySymbol = c.String(maxLength: 100, storeType: "nvarchar"),
            //            Language = c.String(maxLength: 100, storeType: "nvarchar"),
            //            LongDateFormat = c.String(maxLength: 100, storeType: "nvarchar"),
            //            ShortDateFormat = c.String(maxLength: 100, storeType: "nvarchar"),
            //        })
            ...
            CreateTable(
                ...
                c => new
                    {
                        ConnectionId = c.String(nullable: false, maxLength: 100, storeType: "nvarchar"),
                        UsuarioId = c.Guid(nullable: false),
                        UserAgent = c.String(nullable: false, maxLength: 250, storeType: "nvarchar"),
                        Connected = c.Boolean(nullable: false),
                        DataConnected = c.DateTime(nullable: false, precision: 0),
                        DataDisconnected = c.DateTime(precision: 0),
            ...
            CreateTable(
                ...
                c => new
                    {
                        UsuarioId = c.Guid(nullable: false),
                        Nome = c.String(nullable: false, maxLength: 15, storeType: "nvarchar"),
                        Sobrenome = c.String(nullable: false, maxLength: 15, storeType: "nvarchar"),
                        Alias = c.String(nullable: false, maxLength: 36, storeType: "nvarchar"),
                        PaisId = c.String(nullable: false, maxLength: 100, storeType: "nvarchar"),
                        ...
                        Dar = c.DateTime(nullable: false, precision: 0),
                    })
                .PrimaryKey(t => t.UsuarioId)
                .ForeignKey("dbo.Usuario", t => t.UsuarioId)
                .Index(t => t.UsuarioId)
                ...
                c => new
                    {
                        ...
                        Src = c.String(nullable: false, maxLength: 100, storeType: "nvarchar"),
                        Preview = c.String(nullable: false, maxLength: 100, storeType: "nvarchar"),
                        Link = c.String(maxLength: 100, storeType: "nvarchar"),
                        LinkText = c.String(maxLength: 100, storeType: "nvarchar"),
                        Seen = c.String(maxLength: 100, storeType: "nvarchar"),
                        Time = c.String(nullable: false, maxLength: 100, storeType: "nvarchar"),
                        DataStorie = c.DateTime(nullable: false, precision: 0),
                    })
                ...
                c => new
                    {
                        ...
                        DataDepoimento = c.DateTime(nullable: false, precision: 0),
                ...
                c => new
                    {
                        ...
                        DataOperacao = c.DateTime(nullable: false, precision: 0),
                        Uer = c.Guid(),
                        Der = c.DateTime(precision: 0),
                    })
                ...
                c => new
                    {
                        ...
                        DataPost = c.DateTime(nullable: false, precision: 0),
                        Der = c.DateTime(precision: 0),
                    })
                ...
                c => new
                    {
                        ...
                        DataBloqueio = c.DateTime(nullable: false, precision: 0),
                        Uer = c.Guid(),
                        Der = c.DateTime(precision: 0),
                    })
                ...
                c => new
                    {
                        ...
                        DataComentario = c.DateTime(nullable: false, precision: 0),
                        Uer = c.Guid(),
                        Der = c.DateTime(precision: 0),
                    })
                ...
                c => new
                    {
                        ...
                        DataRecado = c.DateTime(nullable: false, precision: 0),
                        StatusRecado = c.Int(nullable: false),
                        DataLeitura = c.DateTime(precision: 0),
                        Uer = c.Guid(),
                        Der = c.DateTime(precision: 0),
                    })
                ...
                c => new
                    {
                        ...
                        ComunidadeId = c.Guid(nullable: false),
                        UsuarioId = c.Guid(nullable: false),
                        DataTopico = c.DateTime(nullable: false, precision: 0),
                        Titulo = c.String(nullable: false, maxLength: 100, storeType: "nvarchar"),
                        Descricao = c.Binary(nullable: false),
                        TipoTopico = c.Int(nullable: false),
                        Uer = c.Guid(),
                        Der = c.DateTime(precision: 0),
                        Uerp = c.Guid(),
                        Derp = c.DateTime(precision: 0),
                    })
                ...
                c => new
                    {
                        ...
                        DataVideo = c.DateTime(nullable: false, precision: 0),
                        Der = c.DateTime(precision: 0),
                    })
                ...
                c => new
                    {
                        ...
                        DataVisita = c.DateTime(nullable: false, precision: 0),
                    })
