    ...
    public class GlobalBaseController : IGlobalBaseController
    {
        ...
        public string GetTemplateMenuVerticalPerfilHtml(Perfil PerfilLogged, Perfil PerfilView)
        {
            ...
            if (validacao.IsMeuPerfil()) /// Menu do meu perfil
            {
                ...
                _recadoService.ObterRecadosRecebidosNaoLidos(PerfilLogged.Id, 0, 0, out int totalRecadosNaoLidos);
                ...
                v_html = @"
                        <ul class='mn-vert'>
                            <li class='menu-li'><div class='icon-edit'></div><a cp='" + PerfilView.Id.ToString() + @"' href='" + urlEdit + @"'>" + UIConfig.EditarPerfil + @"</a></li>
                            <li class='menu-li'><div class='icon-membropend'></div><a item='amigo' cp='" + PerfilView.Id.ToString() + @"' href='" + urlAmigosPend + @"'>" + UIConfig.AmigosPendentes + @"" + v_notif_ami + @"</a></li>
                            <li class='menu-li'><div class='icon-inicio'></div><a cp='" + PerfilView.Id.ToString() + @"' href='" + urlInicio + @"'>" + UIConfig.Inicio + @"</a></li><hr />
                            <li class='menu-li'><div class='icon-perfil'></div><a cp='" + PerfilView.Id.ToString() + @"' href='" + urlPerfil + @"'>" + UIConfig.Perfil + @"</a></li>                
                            <li class='menu-li'><div class='icon-people'></div><a item='amigo' cp='" + PerfilView.Id.ToString() + @"' href='" + urlAmigos + @"'>" + UIConfig.Amigos + @"</a></li>
                            <li class='menu-li'><div class='icon-recado'></div><a cp='" + PerfilView.Id.ToString() + @"' href='" + urlRecados + @"'>" + UIConfig.Recados + @"" + v_recados_naolidos + @"</a></li>
                            <li class='menu-li'><div class='icon-video'></div><a cp='" + PerfilView.Id.ToString() + @"' href='" + urlVideos + @"'>" + UIConfig.Videos + @"</a></li>
                            <li class='menu-li'><div class='icon-depo'></div><a cp='" + PerfilView.Id.ToString() + @"' href='" + urlDepoimentos + @"'>" + UIConfig.Depoimentos + @"</a></li>
                            <li class='menu-li'><div class='icon-cmm'></div><a cp='" + PerfilView.Id.ToString() + @"' href='" + urlComunidades + @"'>" + UIConfig.Comunidades + @"</a></li>
                        </ul>
                    ";
            ...
            {
                var amizade = _amizadeService.Obter(PerfilLogged.Id, PerfilView.Id);
                ...
                if (amizade == null || amizade.StatusSolicitacao == SolicitacaoAmizade.Rejeitado)
                    v_html += @"<li class='menu-li'><div class='icon-addamigo'></div><a cp='" + PerfilView.Id.ToString() + "' class='btnViewPerfil' load='add' href='javascript:void(0);'>" + UIConfig.AdicionarAmigo + @"</a></li>";

                else if (amizade.SolicitadoPorId == PerfilLogged.Id && amizade.StatusSolicitacao == SolicitacaoAmizade.Pendente)
                    v_html += @"<li class='menu-li'><div class='icon-aguradamigo'></div><a cp='" + PerfilView.Id.ToString() + "' href='javascript:void(0);'>" + UIConfig.Esperando + @" " + PerfilView.Nome + " " + UIConfig.aceitar + @"</a></li>";

                else if (amizade.SolicitadoParaId == PerfilLogged.Id && amizade.StatusSolicitacao == SolicitacaoAmizade.Pendente)
                    v_html += @"<li class='menu-li'><div class='icon-aguradamigo'></div><a cp='" + PerfilView.Id.ToString() + "' href='javascript:void(0);'>" + UIConfig.Esperando + @" " + PerfilLogged.Nome + " " + UIConfig.aceitar + @"</a></li>";

                else
                    v_html += @"<li class='menu-li'><div class='icon-delamigo'></div><a cp='" + PerfilView.Id.ToString() + "' cpl='" + PerfilLogged + "' class='btnViewPerfil' load='del' href='javascript:void(0);'>" + UIConfig.RemoverAmigo + @"</a></li>";

                v_html += "<hr />";

                v_html += @"
                        <li class='menu-li'><div class='icon-perfil'></div><a cp='" + PerfilView.Id.ToString() + @"' href='" + urlPerfil + @"'>" + UIConfig.Perfil + @"</a></li>
                        <li class='menu-li'><div class='icon-people'></div><a cp='" + PerfilView.Id.ToString() + @"' href='" + urlAmigos + @"'>" + UIConfig.Amigos + @"</a></li>
                        <li class='menu-li'><div class='icon-recado'></div><a cp='" + PerfilView.Id.ToString() + @"' href='" + urlRecados + @"'>" + UIConfig.Recados + @"</a></li>
                        <li class='menu-li'><div class='icon-video'></div><a cp='" + PerfilView.Id.ToString() + @"' href='" + urlVideos + @"'>" + UIConfig.Videos + @"</a></li>
                        <li class='menu-li'><div class='icon-depo'></div><a cp='" + PerfilView.Id.ToString() + @"' href='" + urlDepoimentos + @"'>" + UIConfig.Depoimentos + @"</a></li>
                        <li class='menu-li'><div class='icon-cmm'></div><a cp='" + PerfilView.Id.ToString() + @"' href='" + urlComunidades + @"'>" + UIConfig.Comunidades + @"</a></li>
                        </ul>
        ...
        public string GetTemplateVisitantesHtml(Perfil PerfilLogged, Perfil PerfilView)
        {
            ...
            if (PerfilLogged.Id != PerfilView.Id)
                return v_html;
            ...
            if (lista.Count() > 0)
            {
                ...
                foreach (var objeto in lista)
                {
                    ...
                    urlResolve = Funcao.ResolveServerUrl("~/Images/perfil/" + perfil.Id.ToString() + "/1.jpg", false);

                    #region HTML

                    v_html += @"
                        <div class='gl-zoom gl-zoom-visitante tooltip2' title='" + perfil.Nome + " " + perfil.Sobrenome + @"'>
                            <a href='" + urlEncryptadaPerfil + "' cp='" + perfil.Id.ToString() + @"'>
        ...
        public string GetTemplateAmigosHtml(Perfil PerfilLogged, Perfil PerfilView)
        {
            ...
            {
                var amigos = _amizadeService.ObterAmigos(PerfilView.Id, 1, FuncaoSite.TOTAL_ITEM_BLOCO, out int totalRecords).ToList();
                ...
                foreach (var amigo in amigos)
                {
                    ...
                    urlResolve = Funcao.ResolveServerUrl("~/Images/perfil/" + amigo.Id.ToString() + "/1.jpg", false);

                    #region HTML

                    v_html += @"
                        <div class='gl-zoom tooltip2' codperfil='" + amigo.Id.ToString() + "' title='" + amigo.Perfil.Nome + " " + amigo.Perfil.Sobrenome + @"'>
                            <a href='" + urlEncryptadaPerfil + "' cp='" + amigo.Id.ToString() + @"'>
        ...
        public string GetTemplateCmmHtml(Perfil PerfilLogged, Perfil PerfilView)
        {
            ...
            {
                int totalRecords;
                var membros = _membroService.ObterComunidades(PerfilView.Id, 1, FuncaoSite.TOTAL_ITEM_BLOCO, out totalRecords).ToList();
                ...
                foreach (var membro in membros)
                {
                    ...
                    urlResolve = Funcao.ResolveServerUrl("~/Images/cmm/" + comunidade.Id.ToString() + "/1.jpg", false);

                    #region HTML

                    v_html += @"
                        <div class='gl-zoom tooltip2' codcmm='" + comunidade.Id.ToString() + "' title='" + comunidade.Nome + @"'>
                         <a href='" + urlEncryptadaCmm + "' cc='" + comunidade.Id.ToString() + @"'>
                             <span class='gl-zoom-caption'>
        ...
        public string GetTemplateMenuVerticalComunidadeHtml(Comunidade ComunidadeView, Perfil PerfilLogged)
        {
            ...
            urlEncryptadaCmm = FuncaoSite.EncryptUrl("c=" + ComunidadeView.Id.ToString());

            var validacao = new CmmValidacao(PerfilLogged, ComunidadeView);

            int totalMembrosPendente;
            var membrosPendentes = _membroService.ObterMembrosPendentes(ComunidadeView.Id, 1, 0, out totalMembrosPendente);

            if (ComunidadeView.IsDono(PerfilLogged.Id))
            {
            ...
            {
                var membro = _membroService.Obter(ComunidadeView.Id, PerfilLogged.Id);
        ...
        public string GetTemplateMembrosHtml(Comunidade ComunidadeView, Perfil PerfilLogged)
        {
            ...
            {
                int totalRecords;
                var membros = _membroService.ObterMembros(ComunidadeView.Id, 1, FuncaoSite.TOTAL_ITEM_BLOCO, out totalRecords).ToList();
                ...
                if (membros.Count > 0)
                {
                    ...
                    foreach (var membro in membros)
                    {
                        ...
                        v_html += @"
                            <div class='gl-zoom tooltip2' codperfil='" + perfilMembro.Id.ToString() + @"' title='" + perfilMembro.Nome + " " + perfilMembro.Sobrenome + @"'>
                             <a href='" + urlEncryptadaPerfil + "' cp='" + perfilMembro.Id.ToString() + @"'>
                                 <span class='gl-zoom-caption'>
