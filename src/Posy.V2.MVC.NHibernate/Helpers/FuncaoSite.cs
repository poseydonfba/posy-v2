...
namespace Posy.V2.MVC.Helpers
{
    public class FuncaoSite
    {
        ...
        // PERFIL
        public static string ROUTE_URL_PREFIXPERFIL = "perfil";

        public static string ROUTE_URL_INICIO = "/inicio";
        public static string ROUTE_URL_PERFIL = "perfil";
        public static string ROUTE_URL_EDITARPERFIL = "/perfil/edit"; //"editperfil";
        public static string ROUTE_URL_AMIGOS = "amigos";
        public static string ROUTE_URL_AMIGOSPEND = "amigos/pendente";
        ...
        public static string ROUTE_URL_EDITCMM = "edit";//"editcmm";
        public static string ROUTE_URL_CADCMM = "cmm/add";
        ...
        public static string getUrlNomeIdPerfil(string alias)
        {
            return Funcao.ResolveServerUrl("~/" + ROUTE_URL_PREFIXPERFIL + "/" + alias, false);
        }

        public static string getUrlNomeIdCmm(string alias)
        {
            return Funcao.ResolveServerUrl("~/" + ROUTE_URL_PREFIXCMM + "/" + alias, false);
        }
        ...
        public static string getPaginacaoPerfil(int paginaAtual, int totalregistros, Perfil perfil, NomePagina nomepagina)
        {
            ...
            string V_URL_PERFIL = getUrlNomeIdPerfil(perfil.Alias) + "/" + nomePagina;
        ...
        /// <param name="nomepagina"></param>
        /// <returns></returns>
        public static string getPaginacaoCmm(int paginaAtual, int totalregistros, Comunidade comunidade, int? topicoId, NomePagina nomepagina)
        {
