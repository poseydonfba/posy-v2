    ...
    public class DatabaseContext : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            **/
            ...
            /**
            * Muda valor padrão de uma string para nvarchar2
            **/
            modelBuilder.Properties<string>()
                .Configure(x => x.HasColumnType("nvarchar2"));

            /**
            * Define as strings como unicode para guardar caracteres especiais
            **/
            modelBuilder.Properties<string>()
                .Configure(x => x.IsUnicode(true));

            /**
            * Muda valor padrão de uma data para timestamp para armazenar data e hora
            **/
            modelBuilder.Properties<DateTime>()
                .Configure(x => x.HasColumnType("TIMESTAMP"));

            /**
            * Muda o tamanho padrão de uma string para 100
            **/
            modelBuilder.Properties<string>()
