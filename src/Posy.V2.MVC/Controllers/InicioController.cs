...
namespace Posy.V2.MVC.Controllers
{
    ...
    public class InicioController : BaseControllerPerfil
    {
        ...
        public ActionResult SalvarPost(PostPerfilModel model)
        {
            ...
            v_html_view += @"
                    <div class='tl-cnt-default-block postado-recente' postId='" + post.PostPerfilId.ToString() + @"' codperfil='" + PerfilLogged.UsuarioId.ToString() + @"'>
        ...
        {
            var posts = _postService.ObterPosts(PerfilLogged.UsuarioId, page, FuncaoSite.TOTAL_POST_PAGE).ToList();
            ...
            if (posts.Count > 0)
            {
                ...
                foreach (var post in posts)
                {
                    ...
                    urlResolve = Funcao.ResolveServerUrl("~/Images/perfil/" + usuarioPost.UsuarioId.ToString() + @"/1.jpg", false);
                    ...
                    if (post.UsuarioId == PerfilLogged.UsuarioId)
                    {
                    ...
                    if (usuarioPost.UsuarioId == PerfilLogged.UsuarioId)
                    ...
                    var usuarioLogadoBloqueadoParaPostarNoUsuarioPost =
                        _perfilBloqueadoService.ObterPerfilBloqueado(usuarioPost.UsuarioId, PerfilLogged.UsuarioId);
                ...
                var proximosPosts = _postService.ObterPosts(PerfilLogged.UsuarioId, nextPage, FuncaoSite.TOTAL_POST_PAGE).ToList();
        ...
        public ActionResult GetListPostComentarios(Guid postid, int page)
        {
