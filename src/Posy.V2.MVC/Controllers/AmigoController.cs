    ...
    public class AmigoController : BaseControllerPerfil
    {
        ...
        public ActionResult AceitarAmigo(AceitarSolicitacaoAmizadeModel model)
        {
            using (_uow)
            {
                ...
                urlResolve = Funcao.ResolveServerUrl("~/Images/perfil/" + perfilAprovado.UsuarioId.ToString() + "/1.jpg", false);
        ...
        public ActionResult GetPerfilAmigos()
        {
            ...
            if (validacao.IsMeuPerfil() || validacao.IsAmigo())
            {
                ...
                int totalRecords;
                var amigos = _amizadeService.ObterAmigos(PerfilView.UsuarioId, PAGE_NUMBER, FuncaoSite.TOTAL_POST_PAGE, out totalRecords).ToList();
        ...
        public ActionResult GetPerfilAmigosPendente()
        {
            ...
            foreach (var solicitacao in solicitacoesRecebidasPendentes)
            {
                ...
                urlResolve = Funcao.ResolveServerUrl("~/Images/perfil/" + usuarioSolicitacao.UsuarioId.ToString() + "/1.jpg", false);
