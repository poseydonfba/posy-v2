...
namespace Posy.V2.Service
{
    public class AmizadeService : IAmizadeService
    {
        ...
        public void AdicionarSolicitacaoAmizade(Guid usuarioIdSolicitado)
        {
        ...
        public void ExcluirAmigo(Guid usuarioIdParaExcluir)
        {
        ...
        public void AceitarSolicitacaoAmizade(Guid usuarioIdAceitar)
        {
        ...
        public void RecusarSolicitacaoAmizade(Guid usuarioIdRecusar)
        {
        ...
        /// <returns></returns>
        public Amizade ObterAmigo(Guid usuarioId, Guid usuarioIdAmigo)
        {
