...
namespace Posy.V2.Service
{
    public class PostPerfilService : IPostPerfilService
    {
        ...
        // METODO 1
        //private IEnumerable<PostPerfil> Posts1(Guid usuarioId, int paginaAtual, int itensPagina)
        //{
        ...
        // METODO 2
        private IEnumerable<PostPerfil> Posts(Guid usuarioId, int paginaAtual, int itensPagina)
        {
