...
namespace Posy.V2.Service
{
    public class TopicoPostService : ITopicoPostService
    {
        ...
        /// <returns></returns>
        public TopicoPost SalvarPost(Guid topicoId, string descricao)
        {
        ...
        public void ExcluirTopicoPost(Guid postId)
        {
            var p = Obter(postId);
            if (p == null)
                throw new Exception("Erro");
        ...
        public void Excluir(Guid postId)
        {
        ...
        /// </summary>
        /// <param name="postId"></param>
        public void ExcluirTopicoPostPermanente(Guid postId)
        {
            var p = Obter(postId);
            if (p == null)
                throw new Exception("Erro");
        ...
        public void ExcluirPermanente(Guid postId)
        {
            var post = Obter(postId);
