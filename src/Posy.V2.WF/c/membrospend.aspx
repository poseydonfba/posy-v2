<%@ Page Title="" Language="C#" MasterPageFile="~/SitePrincipal.Master" AutoEventWireup="true" CodeBehind="membrospend.aspx.cs" Inherits="Posy.V2.WF.c.membrospend" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cntJs" runat="server">
    ...
    <script src="<%= Funcao.ResolveServerUrl("~/js-dev/c/membrospend.js", false) %>" type="text/javascript"></script>
