<%@ Page Title="" Language="C#" MasterPageFile="~/SitePrincipal.Master" AutoEventWireup="true" CodeBehind="cadcmm.aspx.cs" Inherits="Posy.V2.WF.c.cadcmm" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cntJs" runat="server">
    ...
    <script src="<%= Funcao.ResolveServerUrl("~/js-dev/c/cadcmm.js", false) %>" type="text/javascript"></script>
