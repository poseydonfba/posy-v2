<%@ Page Title="" Language="C#" MasterPageFile="~/SitePrincipal.Master" AutoEventWireup="true" CodeBehind="moderadores.aspx.cs" Inherits="Posy.V2.WF.c.moderadores" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cntJs" runat="server">
    ...
    <script src="<%= Funcao.ResolveServerUrl("~/js-dev/c/moderadores.js", false) %>" type="text/javascript"></script>
