<%@ Page Title="" Language="C#" MasterPageFile="~/SitePrincipal.Master" AutoEventWireup="true" CodeBehind="amigos.aspx.cs" Inherits="Posy.V2.WF.P.amigos" %>
    ...
    <div class="ms-cnt-blc ms-cnt-amigos">
        <div class="view-titulo">
            <div class='ms-cnt-tit-blc'>
                <h1 class='ms-tit-blc-txt icon-people'><%= UIConfig.Amigos %></h1>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cntJs" runat="server">
    ...
    <script src="<%= Funcao.ResolveServerUrl("~/js-dev/p/amigos.js", false) %>" type="text/javascript"></script>
