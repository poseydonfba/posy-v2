<%@ Page Title="" Language="C#" MasterPageFile="~/SitePrincipal.Master" AutoEventWireup="true" CodeBehind="depoimentos.aspx.cs" Inherits="Posy.V2.WF.P.depoimentos" %>
    ...
    <div class="ms-cnt-blc ms-cnt-depoimentos">
        ...
        <div class="view-titulo">
            <div class="ms-cnt-tit-blc">
                <h1 class="ms-tit-blc-txt icon-depo"><%= UIConfig.MeusDepoimentos %></h1>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cntJs" runat="server">
    ...
    <script src="<%= Funcao.ResolveServerUrl("~/js-dev/p/depoimentos.js", false) %>" type="text/javascript"></script>
