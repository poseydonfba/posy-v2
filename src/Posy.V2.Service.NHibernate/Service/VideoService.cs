...
namespace Posy.V2.Service
{
    public class VideoService : IVideoService
    {
        ...
        public void ExcluirVideo(int videoId)
        {
        ...
        public Video ObterVideo(int videoId)
        {
        ...
        /// <returns></returns>
        public IEnumerable<Video> ObterVideos(int usuarioId, int paginaAtual, int itensPagina, out int totalRecords)
        {
