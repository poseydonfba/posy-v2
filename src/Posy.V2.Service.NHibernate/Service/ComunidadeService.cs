...
namespace Posy.V2.Service
{
    public class ComunidadeService : IComunidadeService
    {
        ...
        /// <param name="descricaoPerfil"></param>
        /// <returns></returns>
        public Comunidade EditarComunidadePerfil(int comunidadeId, string alias, string nome, int categoriaId, string descricaoPerfil)
        {
        ...
        /// <returns></returns>
        public Comunidade EditarComunidadePrivacidade(int comunidadeId, TipoComunidade tipo)
        {
            var comunidade = Obter(comunidadeId);
            if (comunidade == null)
                throw new Exception(Errors.ComunidadeInvalida);
        ...
        /// </summary>
        /// <param name="comunidadeId"></param>
        public void ExcluirComunidade(int comunidadeId)
        {
            var comunidade = Obter(comunidadeId);
            if (comunidade == null)
                throw new Exception(Errors.ComunidadeInvalida);
        ...
        public Comunidade Obter(int comunidadeId)
        {
        ...
        public TopicoPost ObterUltimoPost(int comunidadeId)
        {
