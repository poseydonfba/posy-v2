...
namespace Posy.V2.Service
{
    public class RecadoComentarioService : IRecadoComentarioService
    {
        ...
        /// <returns></returns>
        public RecadoComentario Comentar(int recadoId, string comentario)
        {
        ...
        public RecadoComentario ObterComentario(int comentarioId)
        {
        ...
        /// <returns></returns>
        public IEnumerable<RecadoComentario> ObterComentarios(int recadoId, int paginaAtual, int itensPagina)
        {
            var recado = _recadoService.ObterRecado(recadoId);
