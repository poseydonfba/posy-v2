...
namespace Posy.V2.Service
{
    public class PostPerfilComentarioService : IPostPerfilComentarioService
    {
        ...
        /// <returns></returns>
        public PostPerfilComentario Comentar(int postId, string comentario)
        {
        ...
        public PostPerfilComentario ObterComentario(int comentarioId)
        {
        ...
        /// <returns></returns>
        public IEnumerable<PostPerfilComentario> ObterComentarios(int postId, int paginaAtual, int itensPagina)
        {
            var post = _postPerfilService.ObterPost(postId);
